            ...
            {products.map((product) => (
              <Card key={product._id} className="group relative overflow-hidden shadow-md">
                ...
                <CardFooter className="flex flex-col items-start gap-4 p-4">
                  ...
                  <Link
                    href={`/shop/id?id=${product._id}&title=${encodeURIComponent(product.title)}&price=${product.price}&imageUrl=${encodeURIComponent(product.imageUrl)}&description=${encodeURIComponent(product.description)}&discountPercentage=${product.discountPercentage}&isNew=${product.isNew}&tags=${product.tags}`}
                  >
