...
export default function StatisticsCharts() {
  return (
    <>
   <span className="ml-[970px]"> <LogoutButton/></span>
    <div className="mt-5 space-y-8 p-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 min-h-screen">
